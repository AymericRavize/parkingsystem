...
public class DBConstants {
    ...
    public static final String GET_NB_TIKET ="select count(ID) from ticket  where VEHICLE_REG_NUMBER=? and IN_TIME>=(NOW() - INTERVAL 7 DAY)";// condition sur la date
}
// limiter a la dernière création  les ancien son il stoker ?